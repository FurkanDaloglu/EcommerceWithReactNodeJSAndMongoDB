                    ...
                    products.map((product,index)=>(
                        ...
                        <div  className="card">
                            ...
                            <div className="card-body">
                                ...
                                <h4 className="text-center mt-1" style={{border:"1px solid", padding:"10px",backgroundColor:"#C0C0C0"}}>Adet: {product.stock}</h4>
                                <h4 className="text-center text-danger mt-1" style={{border:"1px solid", padding:"10px",backgroundColor:"#C0C0C0"}}>Fiyat: {product.price}</h4>
                                {product.stock > 0 ? <button className="btn btn-outline-success w-100" onClick={()=>addBasket(product._id)}>Sepete Ekle</button>
